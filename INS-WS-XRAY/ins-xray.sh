...
sleep 1
# // install bbr -----> folder // CONFIG
echo -e "[ ${green}INFO$NC ] Installing bbr.."
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/valkry7/LT/MONSTER/CONFIG/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
# // install auto&set --->> folder // CONFIG
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/valkry7/LT/MONSTER/CONFIG/auto-set.sh" && chmod +x /usr/bin/auto-set 
# // install crt ----> folder // DOMAIN
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/valkry7/LT/MONSTER/DOMAIN/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
