...
#########################
CDNF="https://raw.githubusercontent.com/valkry7/LT/MONSTER"
REPO="https://raw.githubusercontent.com/myridwan/scriptvps/ipuk/"
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/valkry7/Regist/MONSTER/ipmek > /root/tmp
...
# https://raw.githubusercontent.com/valkry7/Regist/MONSTER/ipmek
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/valkry7/Regist/MONSTER/ipmek | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/valkry7/LT/MONSTER/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/SSH-WS/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/INS-WS-XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/MANAGER/BACKUP/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/INS-WS-XRAY/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/CONFIG/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/UPGRADE/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
echo -e "$green[INFO]$NC INSTALL SLOWDNS"
sleep 2
wget https://raw.githubusercontent.com/valkry7/LT/MONSTER/SLOWDNS/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/valkry7/LT/MONSTER/version  )
...
echo ""  | tee -a log-install.txt
echo "   >>> WhatsApp : +6282240074362(Text Only)"  | tee -a log-install.txt
echo "   >>> Telegram : t.me/LunaticTunnel"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
